...
#train (on small set)
#python -u dependency-parser.py -train -i ../dependency-parsing-files/data/english/train/wsj_train.first-5k.conll06 -m model -e 2 -decrease-alpha -shuffle-sentences
...
#test
python -u dependency-parser.py -test -i ../dependency-parsing-files/data/english/dev/wsj_dev.conll06 -m model -o predicted_decrease-alpha.conll06
